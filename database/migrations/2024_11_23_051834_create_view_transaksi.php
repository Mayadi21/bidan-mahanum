...
SELECT 
    ...
    SUM(dt.harga - IFNULL(dt.potongan, 0)) AS total_harga, -- Menghitung total harga setelah potongan
...
GROUP BY 
    t.id, t.janji_id, pasien.nama, bidan.nama, t.keterangan, t.tanggal, p.judul_promo;
